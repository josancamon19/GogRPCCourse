...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x41, 0x0a, 0x10, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72,
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x56, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x46, 0x0a, 0x09, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x12, 0x19, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x4c, 0x6f,
	0x6e, 0x67, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a,
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x4c, 0x6f, 0x6e, 0x67, 0x47, 0x72, 0x65,
	0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x09,
...
var file_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*LongGreetRequest)(nil),  // 1: greetpb.LongGreetRequest
	(*LongGreetResponse)(nil), // 2: greetpb.LongGreetResponse
}
var file_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greetpb.LongGreetRequest.greeting:type_name -> greetpb.Greeting
	1, // 1: greetpb.GreetService.LongGreet:input_type -> greetpb.LongGreetRequest
	2, // 2: greetpb.GreetService.LongGreet:output_type -> greetpb.LongGreetResponse
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[0], "/greetpb.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}

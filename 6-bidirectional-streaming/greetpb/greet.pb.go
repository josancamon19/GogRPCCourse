...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x22, 0x46,
	...
	0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x45, 0x0a, 0x14, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45,
	0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d,
	...
	0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x54,
	0x0a, 0x0d, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45, 0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x12,
	0x1d, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45,
	0x76, 0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e,
	0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45, 0x76,
	0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x28, 0x01, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x62,
...
var file_greetpb_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_greetpb_greet_proto_goTypes = []interface{}{
	(*Greeting)(nil),              // 0: greetpb.Greeting
	(*GreetEveryoneRequest)(nil),  // 1: greetpb.GreetEveryoneRequest
	(*GreetEveryoneResponse)(nil), // 2: greetpb.GreetEveryoneResponse
}
var file_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greetpb.GreetEveryoneRequest.greeting:type_name -> greetpb.Greeting
	1, // 1: greetpb.GreetService.GreetEveryone:input_type -> greetpb.GreetEveryoneRequest
	2, // 2: greetpb.GreetService.GreetEveryone:output_type -> greetpb.GreetEveryoneResponse
...
func (c *greetServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[0], "/greetpb.GreetService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
